        ...
        value: function updateState() {
            ...
            this.getState().then(function (res) {
                ...
                self.countdown(res.end_time, function (time) {
                    return (0, _jquery2.default)(self.countdown_el).html(time);
                }, function () {
...
var Base = function () {
    ...
    _createClass(Base, [{
        ...
        value: function setOmit(omit) {
            ...
            (0, _jquery2.default)(this.omit_el).each(function (index, item) {
                (0, _jquery2.default)(item).text(this.omit.get(index));
            }.bind(this));
        }
        ...
        value: function toggleCodeActive(e) {
            (0, _jquery2.default)(e.currentTarget).toggleClass('btn-boll-active');
            this.getCount();
        }
        ...
        value: function assistHandle(e) {
            ...
            var btnBoll = (0, _jquery2.default)('.boll-list .btn-boll');
        ...
        value: function getCount() {
            ...
            var count = this.computeCount(active, this.cur_play);
            var range = this.computeBonus(active, this.cur_play);
            var money = count * 2;
        ...
        value: function getTotal() {
            ...
            (0, _jquery2.default)('.codelist li').each(function (index, item) {
                return count += (0, _jquery2.default)(item).attr('count') * 1;
            });
